...
const ContactForm: React.FC = () => {
  ...
  return (
    ...
    <section>
        {/* Contact Section */}
      <div className=" container mx-auto bg-gray-900 text-white py-8 px-2 mt-8">
      ...
      <div className="flex-grow">
        <div className="container mx-auto px-0 pt-0 pb-8">
          <div className="flex flex-col lg:flex-row gap-8 bg-teal-100 p-6 rounded-md">


            {/* Left Content Section */}
            <div className="w-full lg:w-1/2 bg-teal-100 p-6 rounded-md">

                                <div className="text-gray-700 text-xl  mb-4 self-center" style={{ textAlign:"justify"}}>
        Edvenswa is a brand that embodies a customer-first philosophy, striving to understand customer
        needs and tailor solutions accordingly by leveraging innovative approaches to solve business
        challenges across the domains. Our mission is to forge lasting partnerships that empower our
        clients to thrive in an ever-evolving landscape.
</div>
